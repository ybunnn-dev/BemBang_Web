...
@section('styles')
    <link rel="stylesheet" href="{{ asset('css/management/employee.css') }}">
@endsection
    ...
    <div id="content-card">
        ...
        <div class="table-container">
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th scope="col" class="guest-id-column">EMPLOYEE ID</th>
                        <th scope="col" class="guest-name-column">NAME</th>
                ...
                <tbody>
                    <tr onclick="window.location.href='/frontdesk/current-guest'">
                        ...
                        <td><div class="status-div">Morning Shift</div></td>
                    ...
                    <tr onclick="window.location.href='/frontdesk/room-details'">
                        ...
                        <td><div class="status-div">Afternood Shift</div></td>
                        <td>2025-03-23 <br><p style="font-size: 13px;">12:00</p></td>
                    </tr>
                    <tr onclick="window.location.href='/frontdesk/room-details'">
                        <th scope="row" class="guest-id-column2">1001</th>
                    ...
                    <tr onclick="window.location.href='/frontdesk/room-details'">
                        ...
                        <td><div class="status-div">Night Shift</div></td>
                        <td>2025-03-23 <br><p style="font-size: 13px;">12:00</p></td>
                    </tr>
                    <tr onclick="window.location.href='/frontdesk/room-details'">
                        <th scope="row" class="guest-id-column2">1001</th>
