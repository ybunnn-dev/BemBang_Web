<div class="modal fade" id="confirm-check-in-book" tabindex="-1" aria-hidden="true">
      ...
      <div class="modal-footer border-0 pt-2 px-4 pb-4 justify-content-end gap-2" style="padding: 0 30px 30px 30px;">
        ...
        <button type="button" class="btn btn-primary confirm-button px-4 py-2"
                style="font-family: 'Poppins', sans-serif; font-weight: 600; 
                       ...
                       border-radius: 8px; min-width: 100px;" id="confirmProcess" onclick="completeCheckinBook()">
          Confirm
        </button>
      </div>
    </div>
